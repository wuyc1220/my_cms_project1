...
import { getLicense, updateLicense } from '../../api/licenses'
import { getContractsSimple } from '../../api/contracts'
import TrimInput from '../TrimInput'
import { getDictTree } from '../../api/dicts'
import type { LicenseUpdatePayload, LicensePlatformItem, ContractSimpleItem, LicenseListItem } from '../../types/trade'
...
export default function EditLicenseModal({
  ...
  const loadData = async () => {
    try {
      const [dicts, contracts, licenseDetail] = await Promise.all([
        getDictTree(),
        getContractsSimple(),
      ...
      const record = licenseDetail as LicenseListItem
  ...
  return (
    <Modal
      title={t('license.modal.titleEdit')}
      open={open}
      onCancel={closeModal}
